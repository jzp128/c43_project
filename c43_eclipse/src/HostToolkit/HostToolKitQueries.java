...
public class HostToolKitQueries {
	...
	*/
    ...
    public static void main(String[] args) throws ParseException {
        ...
        //HoolToolKitPage weird = new HoolToolKitPage(application.getconn(),"2010-12-02","2010-12-04","toronto","canada","full house");
...
//        
//        //System.out.println(globalPricing(application.getconn(),"2010-12-02","2010-12-04"));
//        
//        ArrayList<Recommendation> recom = globalPricingbyType(application.getconn());
//        
////        for ( Recommendation x : recom){
////        	System.out.println(x.price);
////        	System.out.println(x.type);
////        }
////        recom = globalPricingbyTypeAndRange(application.getconn(),"2010-12-02","2010-12-04");
////        
////        for ( Recommendation x : recom){
////        	System.out.println(x.price);
////        	System.out.println(x.type);
////        }
//        
//        //System.out.println(localPricingbyType(application.getconn(),"canada","toronto"));
//        //System.out.println(localPricingbyTypeDate(application.getconn(),"canada","toronto","2010-12-02","2010-12-04"));
//
//        
//        recom = localPricingbyTypeDate(application.getconn(),"2010-12-02","2010-12-04","toronto","canada");
//        
//        for ( Recommendation x : recom){
//        	System.out.println(x.price);
//        	System.out.println(x.type);
